...
\t\t\t\t\t\t<ul>
\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t<a href=""><span class="insta"><img src="{% static 'img/inst.svg' %}" alt=""></span></a>
\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t<li class="center">
\t\t\t\t\t\t\t\t<a href=""><span class="twitter"><img src="../img/twitter1.svg" alt=""></span></a>
\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t<a href=""><span class="face"><img src="{% static 'img/facebook.svg' %}" alt=""></span></a>
\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t</ul>
\t\t\t\t\t</div>
\t\t\t\t\t<div class="tr">
\t\t\t\t\t\t<a href="" class="">
\t\t\t\t\t\t\tKazakhstan
\t\t\t\t\t\t\t<img src="{% static 'img/kaz.ico' %}" alt="">
\t\t\t\t\t\t</a>
\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t</ul>
\t\t\t\t\t\t<span> © 2022 Spotify by Melomans</span>
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t</div>
\t\t</footer>
